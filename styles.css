...
.hero-carousel::before {
  ...
  position: absolute;
  inset: 0;
  background: linear-gradient(90deg, #ffffff 0%, rgba(255,255,255,0.78) 17%, rgba(255,255,255,0) 46%);
  z-index: 2;
  pointer-events: none;
}
...
.featured-news::after {
  ...
  width: 220px;
  height: 220px;
  background: rgba(246, 195, 59, 0.18);
  border-radius: 50%;
}
...
.featured-news-image {
  ...
  overflow: hidden;
  background: #eef3ee;
  box-shadow: 0 18px 45px rgba(0, 63, 143, 0.16);
}
